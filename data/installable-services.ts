...
export interface ServiceConfig {
  id: string
  name: string
  category: 'database' | 'web-server' | 'runtime' | 'tool' | 'queue' | 'search' | 'communication' | 'media'
  icon: string
...
export const INSTALLABLE_SERVICES: ServiceConfig[] = [
  ...
  },
  {
    ...
    name: 'CockroachDB',
    category: 'database',
    icon: '/icons/services/cockroachdb.svg',
    iconType: 'image',
  ...
  },
  {
    ...
    name: 'CouchDB',
    category: 'database',
    icon: '/icons/services/couchdb.svg',
    iconType: 'image',
  ...
  },
  {
    ...
    name: 'ArangoDB',
    category: 'database',
    icon: '/icons/services/arangodb.png',
    iconType: 'image',
  ...
  },
  {
    ...
    name: 'Memcached',
    category: 'database',
    icon: '/icons/services/memcached.svg',
    iconType: 'image',
  ...
  // Time-Series
  {
    ...
    name: 'InfluxDB',
    category: 'database',
    icon: '/icons/services/influxdb.svg',
    iconType: 'image',
  ...
  },
  {
    ...
    name: 'TimescaleDB',
    category: 'database',
    icon: '/icons/services/timescaledb.svg',
    iconType: 'image',
  ...
  },
  {
    ...
    name: 'QuestDB',
    category: 'database',
    icon: '/icons/services/questdb.svg',
    iconType: 'image',
  ...
  },
  {
    ...
    category: 'database',
    icon: '/icons/services/victoriametrics.png',
    iconType: 'image',
  ...
  // Column-Family
  {
    ...
    category: 'database',
    icon: '/icons/services/cassandra.svg',
    iconType: 'image',
  ...
  },
  {
    ...
    name: 'ScyllaDB',
    category: 'database',
    icon: '/icons/services/scylladb.svg',
    iconType: 'image',
  ...
  // Analytics & Big Data
  {
    ...
    name: 'ClickHouse',
    category: 'database',
    icon: '/icons/services/clickhouse.svg',
    iconType: 'image',
  ...
  // Tools
  {
    ...
    name: 'phpMyAdmin',
    category: 'tool',
    icon: '/icons/services/phpmyadmin.svg',
    iconType: 'image',
